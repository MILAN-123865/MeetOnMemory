...
export const WEBHOOK_EVENTS = Object.freeze([
  {
    ...
    desc: "Fired when a meeting is created.",
  },
  {
    id: "meeting.updated",
    label: "Meeting Updated",
    desc: "Fired when meeting details or processing state changes.",
  },
  {
    id: "meeting.soft_deleted",
    label: "Meeting Soft Deleted",
    desc: "Fired when a meeting is moved to the recycle bin.",
  },
  {
    id: "meeting.restored",
    label: "Meeting Restored",
    desc: "Fired when a deleted meeting is restored.",
  },
  {
    id: "meeting.permanently_deleted",
    label: "Meeting Permanently Deleted",
    desc: "Fired when a meeting is permanently removed.",
  },
  {
    id: "meeting.ended",
    label: "Meeting Ended",
    desc: "Fired when all agenda items are completed or skipped.",
  },
  {
    id: "mom.generated",
  ...
  },
  {
    ...
    desc: "Fired when a new organization policy is uploaded.",
  },
  {
    id: "policy.updated",
    label: "Policy Updated",
    desc: "Fired when a policy is modified or re-analyzed.",
  },
  {
    id: "actionItem.completed",
    label: "Action Item Completed",
    desc: "Fired when an action item is completed or resolved.",
  },
  {
    id: "organization.joined",
    label: "Organization Member Joined",
    desc: "Fired when a user joins an organization.",
  },
  {
    id: "export.ready",
    label: "Data Export Ready",
    desc: "Fired when a requested data export is ready for download.",
  },
  {
    id: "live_meeting.notified",
    label: "Live Meeting Invitation",
    desc: "Fired when participants are invited to a live meeting.",
  },
  {
    id: "gamification.badgesUnlocked",
    label: "Badges Unlocked",
    desc: "Fired when a user unlocks one or more badges.",
  },
]);
